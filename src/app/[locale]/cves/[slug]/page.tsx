...
async function importCve(locale: string, slug: string) {
  const override = hasLocaleOverride(locale, "cves", slug);
  if (override) {
    if (override.endsWith(".mdx")) {
      if (locale === "pt-br") return import(`@content/pt-br/cves/${slug}.mdx`);
      if (locale === "es") return import(`@content/es/cves/${slug}.mdx`);
    }
    if (locale === "pt-br") return import(`@content/pt-br/cves/${slug}.md`);
    if (locale === "es") return import(`@content/es/cves/${slug}.md`);
  }
