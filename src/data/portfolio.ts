...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    featured: true,
    background:
      "HACKSIUM 예선·본선 문제 출제 및 대회 운영을 수행했다. 본선은 해상물류 그룹 대상 실시간 방어 시나리오 'Anchor Watch'를 설계했고, 예선은 부산시 지명을 코드네임으로 한 Forensics·Crypto·Pwn·Rev·Web·Misc 16문제 전체를 출제했다.",
    actions: [
      "본선 LiveFire 블루팀 방어 시나리오 'Anchor Watch' 설계 — 위성·선박·항만·본사IT 4개 Zone, 6시간(3 Phase) 실시간 침해대응 채점 체계 구축",
      "예선 문제 16종 전체 출제 (deadreckon, dilift, dualdoc, gratuitous, hollowshell, lacuna, lighttrap, musefault, neurovault, offbeat, scheming, shardvault, slashcore, urlrift, vaultburn, whisper) — 부산시 지명 코드네임, Forensics/Crypto/Pwn/Rev/Web/Misc 전 카테고리",
      "예선·본선 대회 운영 지원",
    ],
    results: ["HACKSIUM 본선 LiveFire 시나리오 설계 및 예선 16문제 전체 출제, 대회 운영 수행 (기여도 70%)"],
