...
![GetModuleFileName으로 실행 경로 확인](/images/blog/ryuk-ransomware-static-analysis/analysis-00.png)
...
![GetVersionEx + GetWindowsDirectory 호출](/images/blog/ryuk-ransomware-static-analysis/analysis-01.png)

![dwMajorVersion 분기 — Vista 이상이면 C:\Users\Public\ 선택](/images/blog/ryuk-ransomware-static-analysis/analysis-02.png)

![C:\Users\Public\ memcpy 분기](/images/blog/ryuk-ransomware-static-analysis/analysis-03.png)
...
![GetTickCount + rand로 5자리 알파벳 난수 생성](/images/blog/ryuk-ransomware-static-analysis/analysis-04.png)

![RSmEa.exe 문자열 조합 후 CreateFile](/images/blog/ryuk-ransomware-static-analysis/analysis-05.png)
...
![kernel32.dll 로드 후 IsWow64Process 주소 획득](/images/blog/ryuk-ransomware-static-analysis/analysis-06.png)

WOW64(64-bit OS에서 32-bit 프로세스) 여부를 확인하여 내장된 PE 포맷을 선택한다. 32-bit 환경이면 PE32, 64-bit 환경이면 PE32+를 드롭한다.

![kernel32 Free 후 64-bit PE+ 헤더 분기](/images/blog/ryuk-ransomware-static-analysis/analysis-07.png)
...
![ShellExecute로 드롭한 RSmEa.exe 실행](/images/blog/ryuk-ransomware-static-analysis/analysis-08.png)
...
![Sleep 후 CommandLine 파싱 — 페이로드 시작](/images/blog/ryuk-ransomware-static-analysis/analysis-09.png)

![CommandLine 분리 후 Free](/images/blog/ryuk-ransomware-static-analysis/analysis-10.png)

![VersionInformation 구조체 초기화 (내장 페이로드)](/images/blog/ryuk-ransomware-static-analysis/analysis-11.png)

![System32\cmd.exe 문자열 Buffer에 빌드](/images/blog/ryuk-ransomware-static-analysis/analysis-12.png)

![GetModuleFileName으로 sample1_part.exe 경로 확인](/images/blog/ryuk-ransomware-static-analysis/analysis-13.png)
...
![REG ADD 명령으로 Run 키 지속성 등록 — ShellExecute 실행](/images/blog/ryuk-ransomware-static-analysis/analysis-14.png)

`svchos`라는 이름으로 Run 키에 자신을 등록한다. 정상 프로세스 `svchost.exe`와 유사하게 보이도록 이름을 위장한 것이다.

### 프로세스 인젝션 패턴

![TokenHandle로 스레드 권한 조정 후 힙 실행 및 Free](/images/blog/ryuk-ransomware-static-analysis/analysis-15.png)

![프로세스 인젝션 핵심 로직 — 복잡한 코드 영역](/images/blog/ryuk-ransomware-static-analysis/analysis-16.png)
...
![GetModuleFileName + 프로세스 열거 + Alloc→Execute→Free 패턴](/images/blog/ryuk-ransomware-static-analysis/analysis-17.png)
...
![Sample2 바이너리 — 노출된 IP 주소와 Ryuk 문자열](/images/blog/ryuk-ransomware-static-analysis/analysis-18.png)
...
![sub_403FB0 — DLL 로드 및 GetProcAddress 동적 임포트 해석](/images/blog/ryuk-ransomware-static-analysis/analysis-19.png)
...
![배치 파일 + winlogon.exe 생성 후 exit() 강제 종료](/images/blog/ryuk-ransomware-static-analysis/analysis-20.png)
...
![암호화 루틴 1 — 첫 번째 암호화 함수](/images/blog/ryuk-ransomware-static-analysis/analysis-21.png)

![암호화 루틴 2 — 파일 데이터 처리](/images/blog/ryuk-ransomware-static-analysis/analysis-22.png)
...
![XOR 암호화 로직 상세](/images/blog/ryuk-ransomware-static-analysis/analysis-23.png)
...
![vssadmin Delete Shadows /all /quiet 실행 — 백업 삭제](/images/blog/ryuk-ransomware-static-analysis/analysis-24.png)
...
![RukeREADME.txt 링크 생성 — 랜섬 노트 드롭](/images/blog/ryuk-ransomware-static-analysis/analysis-25.png)
