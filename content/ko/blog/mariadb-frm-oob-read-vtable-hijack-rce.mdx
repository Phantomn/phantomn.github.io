...
13.1.0 로컬 체인에 사용된 파이썬 익스플로잇 스크립트 3종(`t16_e2e.py`, `na_frm_rce2_exploit.py`, `target_reliable.py`)을 HackerOne 리포트 원본 첨부 그대로 내려받을 수 있다.

[13.1.0_poc.7z 다운로드](/files/blog/mariadb-frm-oob-rce/13.1.0_poc.7z)

전체 실험 환경(빌드 스크립트 포함)은 배대식(pinebudweiser)의 저장소를 참고한다.
