...
![PLC 환경 구성 (XGI-CPUZ, 베이스 모듈, 전원 모듈)](/images/blog/ls-electric-fuzzer/setup.png)
...
![웜 리스타트를 통한 PLC 초기화 과정](/images/blog/ls-electric-fuzzer/restart.png)
...
![PLC 퍼저 전체 구성도 (패킷 생성 → 전송 → 상태 모니터링 → 크래시 기록 → 초기화)](/images/blog/ls-electric-fuzzer/architecture.png)
