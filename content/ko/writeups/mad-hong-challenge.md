---
title: "Mad Hong — 1Day 1Pwn Project"
date: "2021-01-09"
description: "김동희·홍승표·김원겸의 1D1P(1Day 1Pwn) 프로젝트 — 매일 한 문제씩 풀고 writeup 작성"
tags: ["pwn", "writeup", "project", "1d1p"]
platform: "wargame"
category: "pwn"
difficulty: "Easy"
authors:
...
- 1D1P로 기초 스킬과 꾸준함을 증명
- 이후 CTF를 통해 꾸준히 목적 달성
...
1. 매일 1day writeup 작성(간단한 exploit code라도)

## **특이사항**

1. **정기적인 프로젝트 일정을 정할 필요가 있음**
2. 꾸준함이필요함
3. **`어려운 문제를 풀더라도 다른 쉬운문제를 풀어 1D1P 작성`**
...
## Pwnable To Do by malhyuk

# **Pwnable To Do**

---

# [**Binary Download**](https://aws.ph4nt0m.xyz/pwn)

## **Baby**

[Difficulty : Baby](https://aws.ph4nt0m.xyz/pwn/baby/)

- [TWMMA CTF 2016] Pwn greeting - Format String

- [DEFCON CTF 2016] xkcd - Baby's First

- [DEFCON CTF 2015] r0pbaby - 64 bit ROP

- [DEFCON CTF 2015] babyecho - 32 bit Format String Bug

- [CSAW CTF 2014] Exploitation400 - greenhornd

- [X] [CSAW CTF 2013] Exploitation2 - 200 Points - recv overflow include canary

- [CSAW CTF 2013] Exploitation3 - 300 Points - recv overflow ROP

- [CSAW CTF 2013] Exploitation4 - 400 Points - just overflow

- [ebCTF 2013] pwn200

- [CodeGate 2013] Vuln100 - No Stack Leak
...
- [ksnctf] #04 Villager A - 32bit format string

- [CSAW CTF 2012] 4842 - 200 Points - information leak
...
[Difficulty : Easy](https://aws.ph4nt0m.xyz/pwn/easy/)
...
[Difficulty : Medium easy](https://aws.ph4nt0m.xyz/pwn/medium_easy)
...
[Difficulty : Medium](https://aws.ph4nt0m.xyz/pwn/medium)
...
[Difficulty : Medium hard](https://aws.ph4nt0m.xyz/pwn/medium_hard/)
...
[Difficulty : Hard](https://aws.ph4nt0m.xyz/pwn/hard)
...
- [PlaidCTF 2015] qttpd - Pwnables950 //no binary
